        ...
        {subjects.map((subject, index) => (
          <div key={index} className="subject">
            ...
            <div className="button-container">
              <button onClick={() => increaseHours(index)} className="button increasebtn">
                +
              </button>
              <button onClick={() => decreaseHours(index)} className="button decreasebtn">
                -
              </button>
            </div>
          </div>
